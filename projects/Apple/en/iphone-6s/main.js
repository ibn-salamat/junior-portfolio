...
//model
function showColor1(){
    document.querySelector("div.first h1").innerHTML = "Choose your iphone color.";
    document.querySelector("div.first p").style.display = "none";
    document.querySelector(".model").style.display = "none";
    document.querySelector(".colors").style.display = "flex";
    document.querySelector(".colors .iphone6").style.display = "flex";
    document.getElementById("active").classList.remove("active");
    document.getElementById("color").classList.add("active");
    document.getElementById("view1").style.display = "flex";

    if(document.getElementById("color6").style.display = "flex"){
document.getElementById("color6p").style.display = "none";
}
...
function showColor2(){
    ...
    document.querySelector(".model").style.display = "none";
    document.querySelector(".colors").style.display = "flex";
    document.querySelector(".colors .iphone6p").style.display = "flex";
    document.getElementById("active").classList.remove("active");
    document.getElementById("color").classList.add("active");
    document.getElementById("view2").style.display = "flex";


if(document.getElementById("color6p").style.display = "flex"){
document.getElementById("color6").style.display = "none";
}
}

var background1 = document.querySelectorAll(".colors .iphone6  .background"); 
var background2 = document.querySelectorAll(".colors .iphone6p  .background"); 
...
function showModel(){
    ...
    document.querySelector("div.first h1").innerHTML = "Choose iPhone 6s or iPhone 6s Plus.";
...
function showCapacity(){
    document.querySelector("div.first h1").innerHTML = "Now choose your capacity.";
    document.querySelector("div.first p").style.display = "none";
...
function showFinish(){
    ...
    document.querySelector("div.first h1").innerHTML = "Congratulations!" + "<br>" + "You just bought an iPhone.";
    document.getElementById("gabarits").style.display = "none";
}