...
function showModel(){
    ...
    document.querySelector("div.first h1").innerHTML = "Купите новый iPhone X.";
...
function showFinish(){
    ...
    document.querySelector("div.first h1").innerHTML = "Поздравляем!" + "<br>" + "Вы только что купили iPhone X.";
    document.getElementById("gabarits").style.display = "none";
}